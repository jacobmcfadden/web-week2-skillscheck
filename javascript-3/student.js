...
// Code Here
const groceries = ['Cheese', 'Bottled Water', 'Muffins']; // the essentials!
//////////////////STEP 2////////////////////
//Create a variable called 'yourName' that is assigned the value of your name as a string. 

// Code Here
const yourName = 'Jacob McFadden';
//////////////////STEP 3////////////////////
...
//Using an if/else statement,check
// if the number of groceries is greater than or equal to 5. If it is, return the string 'That looks like a big trip' from the function. 
...
function checkGroceryCount() {
    ...
    } else if(groceries.length === 1) { /// On a tech. note this should be groceries.length === "one"
        return '1 item';
