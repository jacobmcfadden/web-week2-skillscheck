...
// CODE HERE
const faveColors = ['green', 'blue', 'purple'];
//////////////////Step 2////////////////////
...
const me = {
    firstName: 'Jacob',
    superHeroName: 'Mr Unknown',
    homeTown: 'Wright City',
    superPowers: ['Invisibility', 'Time Manipulation', 'Belief Inducement'],
...
//////////////////Step 3////////////////////
// In this step, you will create three variables that will hold some data from your me object. The first variable you create should be 'regularName', and it should receive its value from the value of your firstName key on the me object above. 
